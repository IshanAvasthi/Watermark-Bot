...
async def HelpWatermark(bot, cmd):
		...
		try:
			...
			if user.status == "kicked":
				await bot.send_message(
					...
					text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/IshanDiscussion).",
					parse_mode="markdown",
			...
			await bot.send_message(
				chat_id=cmd.from_user.id,
				text="Something went Wrong. Contact my [Support Group](https://t.me/IshanDiscussion).",
				parse_mode="markdown",
				disable_web_page_preview=True
			)
			return
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/IshanAvasthi"), InlineKeyboardButton("Support Group", url="https://t.me/IshanDiscussion")], [InlineKeyboardButton("Bots Channel", url="https://t.me/IshanUpdates")], [InlineKeyboardButton("Source Code", url="https://github.com/IshanAvasthi/Watermark-Bot")]]),
		disable_web_page_preview=True
	)
...
async def VidWatermarkAdder(bot, cmd):
	...
	if Config.UPDATES_CHANNEL:
		...
		try:
			...
			if user.status == "kicked":
				await bot.send_message(
					chat_id=cmd.from_user.id,
					text="Sorry Son, You are Banned to use me. Contact my [Support Group](https://t.me/IshanDiscussion).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
	...
	try:
		...
		sent_vid = await bot.send_video(
			...
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/IshanAvasthi")], [InlineKeyboardButton("Bots Channel", url="https://t.me/IshanUpdates")], [InlineKeyboardButton("Support Group", url="https://t.me/IshanDiscussion")]]),
			progress=progress_for_pyrogram,
			progress_args=(
				"Uploading, Wait Sir ...",
				editable,
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
		...
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/IshanAvasthi"), InlineKeyboardButton("Support Group", url="https://t.me/IshanDiscussion")], [InlineKeyboardButton("Bots Channel", url="https://t.me/IshanUpdates")]]),
			disable_web_page_preview=True
		)
